...
Напишите текст
https://github.com/Traveler157/stepik_new1.git
Решение #513383579 отправлено на проверку
5 рецензий отправлены
Давая дополнительные рецензии, вы поможете другим учащимся быстрее получить оценку.
3 рецензии получены
Ваш ответ оценили на 3 из 5 баллов
Решило 2 533 человека
------------------------------------------------------------------------------------------------
Подставить значение кнопки " Добавить тавар в корзинe"|
                                                      |
rest_text = browser.find_element_by_xpath('//*[@id="add_to_basket_form"]//buttЕon') # нет кнопки.
rest_text = browser.find_element_by_xpath('//*[@id="add_to_basket_form"]//button') #  Есть кнопка.                                                    | 